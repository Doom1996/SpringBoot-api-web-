...
async function registerUser(){
    ...
    datos.name = document.getElementById(`txtName`).value;//se lee los datos del html/DOM
    datos.lastName = document.getElementById(`txtLastName`).value;//lastName: "Juanito"
    ...
    if(repeatPass != datos.password){
        alert("La contraseña ingresada es diferente,pruebe otra vez!!!");
        return;
    }
